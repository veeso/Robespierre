...
public class TestSubject {
  ...
  public void shouldInstantiateCategoryNew() {
    ...
    Subject subject = new Subject("foo bar", LocalDate.of(1960, 5, 14), "us", "foo bar is a nice person", "123", cat);
  ...
  public void shouldInstantiateCategory() {
    ...
    Category cat = new Category("politician");
    Subject subject = new Subject(testId, "foo bar", LocalDate.of(1960, 5, 14), "us", "foo bar is a nice person", "123", LocalDateTime.of(2020, 6, 28, 12, 45, 54), cat);
